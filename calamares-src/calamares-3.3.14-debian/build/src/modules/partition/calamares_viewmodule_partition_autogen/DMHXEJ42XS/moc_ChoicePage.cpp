...
template <> constexpr inline auto ChoicePage::qt_create_metaobjectdata<qt_meta_tag_ZN10ChoicePageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'manualPartitioningRequested'
...
void ChoicePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->manualPartitioningRequested(); break;
        case 4: _t->onPartitionToReplaceSelected((*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[2]))); break;
        case 5: _t->doReplaceSelectedPartition((*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        case 6: _t->doAlongsideSetupSplitter((*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[2]))); break;
        case 7: _t->onEncryptWidgetStateChanged(); break;
        case 8: _t->onHomeCheckBoxStateChanged(); break;
        case 9: _t->onActionChanged(); break;
        case 10: _t->onEraseSwapChoiceChanged(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (ChoicePage::*)()>(_a, &ChoicePage::deviceChosen, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (ChoicePage::*)()>(_a, &ChoicePage::manualPartitioningRequested, 3))
            return;
    }
}
...
// SIGNAL 3
void ChoicePage::manualPartitioningRequested()
{
