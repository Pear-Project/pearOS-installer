"""Port of templates/agreement.html — same Terms of Service text, in a
scrollable read-only TextView instead of a scrolling <p>."""
import gi
...
You agree to provide us with complete and accurate email address as contact data when you register for an account. The services may be used under a pseudonym. If your contact data changes after registration, you must update the information in your user account without delay or notify us of the changes if they are unable to make the changes themselves.
...
class AgreementPage:
    def __init__(self, app):
        ...
        self.title = make_title("Terms and Conditions")
        content.append(self.title)
        self.description = make_description(
            "Important: Use of your pearOS Computer, the pearOS software and "
            "related services is subject to these Terms and Conditions. Please "
            "read them carefully"
        )
        ...
        # WORD-only wrap can't break an unbroken run of characters (this
        # text has a couple of long URLs) - it just grows the TextView
        # instead, which was blowing the whole card out past 800px wide.
    ...
    def on_show(self):
        ...
        self.description.set_label(
            self.app.t(
                ...
                "Important: Use of your pearOS Computer, the pearOS software and "
                "related services is subject to these Terms and Conditions. "
